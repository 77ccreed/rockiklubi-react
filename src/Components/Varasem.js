        ...
        <Container fluid>
          <div className="row">
            <div className="col-lg-6">
              <h3 className="suurem-pealkiri">Varasem</h3>
              <VarasemCarousel />
            </div>

            <div className="col-lg-6 text-left align-self-center">
              <h3 className="suurem-pealkiri">Jutt toimunud ürituste kohta</h3>
              <h5 className="väiksem-pealkiri">Natukene pikem jutt - kokkuvõte. Paarkõmmend sõna. Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus dignissimos iste voluptas! Quae eaque totam ullam unde corporis nulla numquam!</h5>
              <p className="tekst">
