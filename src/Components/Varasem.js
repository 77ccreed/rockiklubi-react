        ...
        <Container fluid>
          <div className="row">
            ...
            <div className="col-lg-6 text-left align-self-center mt-4">
              ...
              <h5 className="väiksem-pealkiri p-2">Natukene pikem jutt - kokkuvõte. Paarkõmmend sõna. Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus dignissimos iste voluptas! Quae eaque totam ullam unde corporis nulla numquam!</h5>
