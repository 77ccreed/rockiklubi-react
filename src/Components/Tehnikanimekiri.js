        ...
        <Jumbotron fluid className="Tehnikanimekiri">
          <Container fluid>
            <div className="row">
              ...
              <div className="col-lg-8 text-left text align-self-center">
                <h3 className="suurem-pealkiri-hele">Jutt tehnika kohta</h3>
                <h5 className="väiksem-pealkiri-hele">Natukene pikem jutt - kokkuvõte. Paarkõmmend sõna. Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus dignissimos iste voluptas! Quae eaque totam ullam unde corporis nulla numquam!</h5>
                <p className="tekst-hele">
