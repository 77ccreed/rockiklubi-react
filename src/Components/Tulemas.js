...
<UritusedCarousel />
            ...
            <div className="col-lg-6 text-left align-self-center">
              <h3 className="suurem-pealkiri">Jutt ürituste kohta</h3>
              <h5 className="väiksem-pealkiri">Natukene pikem jutt - kokkuvõte. Paarkõmmend sõna. Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab iste voluptate dicta culpa id in.</h5>
              <p className="tekst">
