      ...
      <div className="col-md-2 mx-auto my-4 text-center d-flex flex-wrap align-content-center">
        ...
        <a href="https://www.facebook.com/Valga-Rockiklubi-141376155934174/" target="_blank" className="col-12 p-1 m-2"
          rel="noopener noreferrer" title="FaceBook">
            <svg aria-hidden="true" data-prefix="fab" data-icon="facebook-square" className="svg-inline--fa fa-facebook-square fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M448 80v352c0 26.5-21.5 48-48 48h-85.3V302.8h60.6l8.7-67.6h-69.3V192c0-19.6 5.4-32.9 33.5-32.9H384V98.7c-6.2-.8-27.4-2.7-52.2-2.7-51.6 0-87 31.5-87 89.4v49.9H184v67.6h60.9V480H48c-26.5 0-48-21.5-48-48V80c0-26.5 21.5-48 48-48h352c26.5 0 48 21.5 48 48z"></path></svg>
        </a>

        <a href="https://github.com/77ccreed/valga-rokiklubi" target="_blank" className="col-12 p-1 m-2" rel="noopener noreferrer" title="GitHub">
